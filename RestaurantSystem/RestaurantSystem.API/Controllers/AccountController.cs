namespace RestaurantSystem.API.Controllers
{
    ...
    using RestaurantSystem.API.Providers;
    using RestaurantSystem.API.Results;
    ...
    public class AccountController : ApiController
    {
            ...
            bool generateState = false)
        {
            ...
            return new ManageInfoViewModel
            {
                ...
                ExternalLoginProviders =
                    this.GetExternalLogins(returnUrl, generateState)
            };
        }
        ...
        {
            var descriptions =
                this.Authentication.GetExternalAuthenticationTypes();
                    ...
                    Url =
                        this.Url.Route(
                            ...
                            new
                            {
                                ...
                                redirect_uri =
                                    new Uri(this.Request.RequestUri, returnUrl)
                                        .AbsoluteUri,
                                state
                            }),
                    State = state
